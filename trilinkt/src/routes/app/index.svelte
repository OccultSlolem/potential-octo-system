...
<button class="btn ml-20 mb1" on:click={() => reload()}>Reload</button>

{#if merchant == undefined}
	<h1 class="ml-20">Loading..</h1>
{:else}
    <div class="ml-20 mb-20 mr-20">
	...
	<p>
		Your API Key won't become valid until you add a name and products. If you regenerate your API
		key, your existing key will be revoked.
	</p>
	<div class="divider" />
